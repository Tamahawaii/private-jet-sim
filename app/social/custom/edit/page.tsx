...
function CustomPersonaEdit() {
   const search = useSearchParams();
   const resolvedParams = { id: search.get('id') || '' };
      ...
      <div className="absolute inset-0 z-40 bg-[#0a0a0c] pt-24 px-10 pb-10 overflow-y-auto text-white">
         <div className="max-w-4xl mx-auto flex flex-col gap-8">
            <div className="flex items-end justify-between border-b border-white/10 pb-4">
               <div>
                  <button onClick={() => router.push(routes.persona(persona.id))} className="text-zinc-500 hover:text-white transition-colors mb-4 flex items-center gap-2 text-xs font-mono tracking-widest uppercase">
...
export default function Page() {
  return <Suspense fallback={null}><CustomPersonaEdit /></Suspense>;
}
