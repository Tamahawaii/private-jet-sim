   ...
   return (
      ...
      >
         ...
         <div className="px-6 pb-6 overflow-y-auto no-scrollbar space-y-5">
            ...
            {reactor && (
               <button onClick={() => router.push(routes.dm(reactor.id))} className="w-full flex items-center gap-3 bg-[#f5a7a7]/10 border border-[#f5a7a7]/25 rounded-2xl p-3 text-left">
