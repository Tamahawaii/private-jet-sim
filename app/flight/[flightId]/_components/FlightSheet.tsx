            ...
            {state === 'full' && (
              <>
                ...
                <div className="flex gap-2">
                  <button onClick={() => router.push(`/fleet/${aircraft.tailNumber}`)} className="flex-1 h-11 rounded-xl bg-white/6 border border-white/10 text-white text-[12px] font-semibold flex items-center justify-center gap-1.5"><MapPin size={13} /> Aircraft <ChevronRight size={13} /></button>
                  {snap.progress < 0.2 && (
